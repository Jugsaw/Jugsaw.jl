...
publish(job_status::JobEvent) = publish_event(JOB_PUB_SUB, string(job_status.status), job_status; headers=Pair{SubString{String},SubString{String}}["Content-Type"=>"application/json"])
