...
lazyreturn = app.f(nothing, true, 1, 1.0, [1, 2, 3], reshape([1, 3, 2, 4], 2, 2), Dict(2 => 3), "EA", (1, 2); a = 1.0e-8, b = Dict(2 => 4))
...
lazyreturn = app.f(None, True, 1, 1.0, [1, 2, 3], numpy.reshape([1, 3, 2, 4], (2, 2), order='F'), {2:3}, "EA", (1, 2), a = 1.0e-8, b = {2:4})
result = lazyreturn()   # fetch result"""
end
